  ...
  window.createUnitContactApplicationModule = function createUnitContactApplicationModule(deps) {
    ...
    function renderApplyForm() {
      ...
      mount.innerHTML = ''
        ...
        + '</div>'
        + '<div class="form-row unit-contact-compact-row">'
        + '<div class="form-group"><label class="form-label form-required">申請電子郵件</label><input type="email" class="form-input" id="uca-email" data-testid="unit-contact-email" placeholder="請輸入可收信的電子郵件（例如 ntu.edu.tw 的信箱或 Gmail）" required></div>'
        ...
        + '<li>申請電子郵件可填 ntu.edu.tw 的信箱、Gmail 或其他可正常收信的信箱。</li>'
