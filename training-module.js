...
(function () {
  window.createTrainingModule = function createTrainingModule(deps) {
    ...
    const TRAINING_DEFERRED_SYNC_TIMEOUT_MS = 60;
    const TRAINING_ROUTE_SETTLE_DELAY_MS = 120;
    const TRAINING_IDLE_CALLBACK_TIMEOUT_MS = 60;
    const TRAINING_RERENDER_RETRY_DELAY_MS = 60;
    const TRAINING_FOCUS_RESTORE_DELAY_MS = 120;
  ...
  function buildTrainingFillPage(params) {
    ...
    return '<div class="animate-in">'
      ...
      + '<div class="training-record-table-wrap" id="training-record-table-wrap">' + buildTrainingTableMarkup('<th class="training-col-select"><input type="checkbox" id="training-select-all"></th><th class="training-col-index">序號</th><th class="training-col-name">姓名 / 來源</th><th class="training-col-unit">本職單位</th><th class="training-col-identity">身分別</th><th class="training-col-job">職稱</th><th class="training-col-status">在職狀態</th><th class="training-col-general">' + TRAINING_GENERAL_LABEL + '</th><th class="training-col-info-staff">' + TRAINING_INFO_STAFF_LABEL + '</th><th class="training-col-professional">' + TRAINING_PROFESSIONAL_LABEL + '</th><th class="training-col-result">判定</th><th class="training-col-note">備註</th><th class="training-col-actions">操作</th>', '', { tbodyId: 'training-rows-body' }) + '</div>'
