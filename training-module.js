(function () {
  ...
  function buildTrainingFillPage(params) {
    ...
    return '<div class="animate-in">'
      ...
      + '<div class="training-record-table-wrap" id="training-record-table-wrap">' + buildTrainingTableMarkup('<th class="training-col-select"><input type="checkbox" id="training-select-all"></th><th class="training-col-index">摨?</th><th class="training-col-name">憪? / 靘?</th><th class="training-col-unit">?祈?桐?</th><th class="training-col-identity">頨怠???</th><th class="training-col-job">?瑞迂</th><th class="training-col-status">?刻???</th><th class="training-col-general">' + TRAINING_GENERAL_LABEL + '</th><th class="training-col-info-staff">' + TRAINING_INFO_STAFF_LABEL + '</th><th class="training-col-professional">' + TRAINING_PROFESSIONAL_LABEL + '</th><th class="training-col-result">?文?</th><th class="training-col-note">?酉</th><th class="training-col-actions">??</th>', '', { tbodyId: 'training-rows-body' }) + '</div>'
