...
(function () {
  ...
  // 引用 shared/unit-categories.js 的共用白名單（Single Source of Truth）
  const _uc = (typeof window !== 'undefined' && window.__UNIT_CATEGORIES__) || {};
  const UNIT_ADMIN_PRIMARY_WHITELIST = new Set(_uc.ADMIN_UNITS || []);
  const UNIT_ACADEMIC_PRIMARY_WHITELIST = new Set(_uc.ACADEMIC_UNITS || []);
