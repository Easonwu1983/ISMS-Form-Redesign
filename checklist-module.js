  ...
  function buildChecklistItemBlock(item, saved, sectionIndex, editable = true) {
    ...
    return `<div class="cl-item${editable ? '' : ' cl-item--locked'}" id="cl-item-${item.id}" data-cl-item-id="${item.id}" data-cl-section-index="${sectionIndex}" tabindex="-1">
      ...
      <div class="cl-item-body">
        ...
        <div class="cl-fields">
          <div class="form-group"><label class="form-label">\u57f7\u884c\u60c5\u5f62\u8aaa\u660e</label><textarea class="form-textarea cl-textarea" id="cl-exec-${item.id}" placeholder="${esc(item.hint)}" rows="2" aria-required="true"${editable ? '' : ' readonly'}>${esc(saved.execution || '')}</textarea></div>
          <div class="form-group"><label class="form-label">\u4f50\u8b49\u8cc7\u6599\u8aaa\u660e</label><textarea class="form-textarea cl-textarea" id="cl-evidence-${item.id}" placeholder="\u4f8b\u5982\u6587\u4ef6\u540d\u7a31\u3001\u756b\u9762\u622a\u5716\u3001\u8def\u5f91\u6216\u88dc\u5145\u8aaa\u660e" rows="2" aria-required="true"${editable ? '' : ' readonly'}>${esc(saved.evidence || '')}</textarea></div>
