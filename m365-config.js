...
﻿(function () {
  const BASE_CONFIG = {
    ...
    assetInventoryMode: 'local-emulator',
    assetInventoryEndpoint: '',
    assetInventoryHealthEndpoint: '',
    assetInventorySharedHeaders: {},
  ...
  const DEPLOYMENT_PROFILES = {
    ...
    a3CampusBackend: {
      ...
      assetInventoryMode: 'm365-api',
      assetInventoryEndpoint: '/api/assets',
      assetInventoryHealthEndpoint: '/api/assets/health',
