(function () {
  window.createShellModule = function createShellModule(deps) {
    ...
    function renderLogin() {
      ...
      document.body.innerHTML = '<a class="skip-link" href="#app">頝喳銝餉??批捆</a><div class="login-page" tabindex="0" aria-label="Login page"><main class="login-card" id="app" tabindex="-1" role="main" aria-labelledby="login-page-title">' +
