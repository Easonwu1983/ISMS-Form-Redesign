(function () {
  window.createAdminCollectionCacheModule = function createAdminCollectionCacheModule() {
    ...
    function createRenderCache() {
      return { signature: '', filterSignature: '' };
    }
    ...
    function resetRenderCaches(renderCache, markupCache) {
      if (renderCache && typeof renderCache === 'object') {
        renderCache.signature = '';
        if (Object.prototype.hasOwnProperty.call(renderCache, 'filterSignature')) {
          renderCache.filterSignature = '';
        }
      }
      if (markupCache && typeof markupCache === 'object') {
        markupCache.signature = '';
        markupCache.html = '';
      }
    }
