...
| C6 | Critical | 已驗證 | 已補 rollback、cache invalidation、corruption warning，且已改成 versioned mutate / live suite 驗證，資料層的競態風險已關閉。 | [data-module.js](C:\Users\User\Playground\ISMS-Form-Redesign\data-module.js) |
...
| M15 | Medium | 已驗證 | checklist JS submit validation 已補 unit non-empty 檢查，並完成 live 驗證。 | [checklist-module.js](C:\Users\User\Playground\ISMS-Form-Redesign\checklist-module.js) |
| M16 | Medium | 已驗證 | checklist duplicate check 已擴到 admin / multi-unit，不再只限 single-unit，且已驗證。 | [checklist-module.js](C:\Users\User\Playground\ISMS-Form-Redesign\checklist-module.js), [app.js](C:\Users\User\Playground\ISMS-Form-Redesign\app.js) |
...
| L9 | Low | 已驗證 | tracking UI 已加入 `Round N/3`。 | [case-module.js](C:\Users\User\Playground\ISMS-Form-Redesign\case-module.js) |
| L10 | Low | 已驗證 | Graph upstream error 已改為 server-side log + generic client message。 | [server.cjs](C:\Users\User\Playground\ISMS-Form-Redesign\m365\campus-backend\server.cjs) |
| L11 | Low | 已驗證 | audit row failure 不再 silent ignore，改成 console error。 | [server.cjs](C:\Users\User\Playground\ISMS-Form-Redesign\m365\campus-backend\server.cjs) |
